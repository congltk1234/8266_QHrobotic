...
char command; 
int moveSpeed = 220;
int turnSpeed = 255 - moveSpeed;
int times = 2; double bonus = 2.25;
...
//    Stop(); //initialize with motors stoped
    ...
    case 'G': // FowardLeft
      ...
      motor1.setSpeed(moveSpeed + turnSpeed);
      motor4.setSpeed(moveSpeed - turnSpeed*times);
      forward();
    case 'I': // FowardLeft
      Serial.println("Forward_Right");
      motor4.setSpeed(moveSpeed + turnSpeed); 
      motor1.setSpeed(moveSpeed - turnSpeed*(times+bonus));
      forward();
    case 'H': // Back_Left();
      motor1.setSpeed(moveSpeed + turnSpeed);
      motor4.setSpeed(moveSpeed - turnSpeed*times);
